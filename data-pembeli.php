...
<div class="topbar">
    ...
    <div class="menu">
        ...
        <a href="data-pembeli.php" class="active">Data Pembeli</a>
            ...
            <tbody>
                <?php $no = 1; while ($row = mysqli_fetch_assoc($result)) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="edit-pembeli.php?id=<?= $row['id'] ?>" class="btn-ungu"><i class="fas fa-edit"></i> Edit</a>
                            <a href="hapus-pembeli.php?id=<?= $row['id'] ?>" class="btn-merah" onclick="return confirm('Yakin ingin menghapus pembeli ini?')"><i class="fas fa-trash"></i> Hapus</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
